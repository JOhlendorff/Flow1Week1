...
public class EMF_Creator {
    ...
    private static EntityManagerFactory createEntityManagerFactory(boolean isTest) {
        ...
        if (isDeployed) {
            ...
            String user = System.getenv("dev");
            String pw = System.getenv("ax2");
//            HUSK at ændre databasenavn herinde
            String connection_str = System.getenv("jdbc:mysql://localhost:3306/week1day5?zeroDateTimeBehavior=CONVERT_TO_NULL");
