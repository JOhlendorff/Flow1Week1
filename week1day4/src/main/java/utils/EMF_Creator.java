...
public class EMF_Creator {
    ...
    private static EntityManagerFactory createEntityManagerFactory(boolean isTest) {
        ...
        if (isDeployed) {
            ...
            String user = System.getenv("loppen");
            String pw = System.getenv("hopper3");
//            HUSK at ændre databasenavn herinde
            String connection_str = System.getenv("jdbc:mysql://localhost:3306/week1day4?zeroDateTimeBehavior=CONVERT_TO_NULL");
